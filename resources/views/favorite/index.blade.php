    ...
    <div class="p-4 lg:ml-64 mt-14 lg:mt-12">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg">
            ...
            <div class="flex flex-col p-4 mb-4 rounded bg-gray-50">
                <div class="mb-4">
                    <h1 class="text-2xl font-semibold text-gray-700">Destinasi yang anda sukai</h1>
                </div>
                            ...
                            @foreach ($favorites as $favorite)
                                <tr class="bg-white border-b">
                                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        {{ $favorite->destinasi->nama }}
                                    </th>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        <div class="flex gap-1 items-center justify-end">
                                            <a href="/destinasi/{{ $favorite->destinasi->slug }}" class="font-medium text-white p-2 bg-green-600 hover:bg-green-700 rounded-lg">
