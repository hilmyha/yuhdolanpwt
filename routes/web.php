...
Route::group(['middleware' => 'auth'], function () {
    ...
    // ulasan
    Route::get('/dashboard/ulasan', [App\Http\Controllers\Admin\UlasanController::class, 'index'])->name('ulasan.index');
    ...
    // favorite
    Route::get('/dashboard/favorite', [App\Http\Controllers\Admin\FavoriteController::class, 'index'])->name('favorite.index');
